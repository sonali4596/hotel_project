							...
							<div class="Aa201812261653Au_">
								<div class="Aa201812261709Ay_">
									<div class="Aa201812261714Au_">
										<!-- top heading-->
										<div class="Aa201812261716At_"><h1>Order For Food</h1></div>
											...
											<div class="Aa201812261756Ay_">
															...
															<div class="Aa201812262312Fg_">
																...
																<div class="Aa201812262314Ar_">
																	<div class="Aa201812262334Au_">
																		<span>Order Time : <?php echo date("H:i") ?></span>
																	</div>
																</div>
															</div>
															<div class="Aa201812262312Fg_">
																...
																<div class="Aa201812262314Ar_">
																	<div class="Aa201812262334Au_">
																		<span>Order Completing Time : <?php echo date("H:i") ?></span>
																	</div>	
																</div>
															</div>
														</div>
													...
													<div class="Aa201812262340Au_">
														<div class="Aa201812262352Ay_">
															<div class="Aa20181227000Ay_">
																...
																<span>1 Burger</span>
																<a href="order-food.php"><button>Edit</button></a>
															</div>
														</div>
													</div>
												</div>
														...
														<div class="Aa20181227058Au_">
															<div class="Aa20181227058Au_">
																	...
																	<div class="Aa20181227102Au_">
																		<div class="Aa20181227104Au_">
																			<div class="Aa20181227105Ay_">
																				<div class="Aa20181227102Au_" >
																					<div class="Aa20181227107Ay_">Order Amount</div>
																			...
																			<div class="Aa20181227105Ay_">
																				<div class="Aa20181227102Au_">
																					<div class="Aa20181227107Ay_"><i class="fa fa-inr"></i> 60 x 1 Room</div>
																...
																<div class="Aa20181227101Aa_">
																	<div class="Aa20181227102Au_">
																		<div class="Aa20181227107At_"><i class="fa fa-inr"></i> 60</div>
																		<div class="Aa20181227107At_"><i class="fa fa-inr"></i> 12</div>
																		<div class="Aa20181227107At_">&#45; <i class="fa fa-inr"></i> 12</div>
																		<div class="Aa20181227107At_"><i class="fa fa-inr"></i> 60</div>
																	</div>
																</div>
												...
												<div class="Aa20181227034At_">
													<div class="Aa20181227035Au_">
														...
														<button class="Aa20191021118At_"><i class="fa fa-long-arrow-right"></i> Pay At Room</button>
													</div>
												</div>
											</div>
										</div>
		...
		<script>
			$(document).ready(function(){
                ...
                $(".Aa20191021118Ar_").click(function(){
                    $(".Aa2019131120Ar_").attr("action","php/order-food.php?amount=3000&pay=paid");
                    $(".Aa2019131120Ar_").submit();
                    
                });
                $(".Aa20191021118At_").click(function(){
                    $(".Aa2019131120Ar_").attr("action","php/book.php?amount=3000&pay=Pay At Room");
                    $(".Aa2019131120Ar_").submit();
